...
const secretEnv = {
  ...
  // Google Auth
  GOOGLE_AUTH_CREDENTIALS_PATH: _getEnv('GOOGLE_AUTH_CREDENTIALS_PATH'),

  // private key
  WALLET_PRIVATE_KEY: _getEnv('WALLET_PRIVATE_KEY'),
...
const databaseEnv = {
  ...
  SEQUELIZE_TIMEZONE: _getEnv('SEQUELIZE_TIMEZONE', 'UTC'),
}
...
const thirdPartyEnv = {
  ...
  // spreadsheet
  SPREADSHEET_ID: _getEnv('SPREADSHEET_ID'),
}
